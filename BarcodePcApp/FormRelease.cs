...
namespace BarcodePcApp
{
    public partial class FormRelease : Form
    {
        ...
        public FormRelease()
        {
            ...
            if (lang == true)
            {
                this.lblRelease.Text = "Frisläppta produkter";
                this.btnExecute.Text = "Kör";
                this.btnPrint2.Text = "Skriv ut rapport";
                this.lblDismissed.Text = "Ej frisläppta produkter";
                this.btnClose.Text = "Stäng";
                this.scannerCheckBox.Text = "Scan && check out";
                this.buttonScanned.Text = "Check out";
                this.Text = "Frisläppa produkter";
                sprak = 0;
        ...
        private void LoadData(object sender, EventArgs e)
        {
            ...
            try
            {
                prod = bc.GetReleaseProducts(databas, kemiDb, userId, orgid, verkId,sprak);
        ...
        //}
            ...
            if (Convert.ToInt32(ds.Tables["ProdId"].Rows[0]["id"]) > 0)
            {
                ...
                if (dt2.Rows.Count > 0)
                {
                    ...
                    if (lang == true)
                    {
                        ReleaseDataGridView.Columns[0].HeaderText = "Streckkod";
                        ReleaseDataGridView.Columns[0].Width = 50;
                        ReleaseDataGridView.Columns[1].HeaderText = "Produkt";
                        ...
                        ReleaseDataGridView.Columns[3].HeaderText = "Leverantör";
                        ReleaseDataGridView.Columns[3].Width = 50;
                        ReleaseDataGridView.Columns[4].HeaderText = "Artnr";
                        ...
                        ReleaseDataGridView.Columns[6].HeaderText = "Mängd";
                        ReleaseDataGridView.Columns[6].Width = 40;
                        ReleaseDataGridView.Columns[7].HeaderText = "Enhet";
                        ...
                        ReleaseDataGridView.Columns[8].HeaderText = "Registreringsdatum";
                        ReleaseDataGridView.Columns[8].Width = 50;
                        ReleaseDataGridView.Columns[9].HeaderText = "Förfallodatum";
                ...
                if (dt3.Rows.Count > 0)
                {
                    ...
                    if (lang == true)
                    {
                        ...
                        DismissedDataGridView.Columns[0].HeaderText = "Produkt";
                        ...
                        DismissedDataGridView.Columns[2].HeaderText = "Leverantör";
                        DismissedDataGridView.Columns[2].Width = 100;
                        DismissedDataGridView.Columns[3].HeaderText = "Artnr";
                        ...
                        DismissedDataGridView.Columns[5].HeaderText = "Mängd";
                        DismissedDataGridView.Columns[5].Width = 40;
                        DismissedDataGridView.Columns[6].HeaderText = "Enhet";
                        DismissedDataGridView.Columns[6].Width = 30;
                        //ReleaseDataGridView.Columns[7].Name = "Print label";
                        //ReleaseDataGridView.Columns[7].Width = 50;
                        DismissedDataGridView.Columns[7].HeaderText = "Registreringsdatum";
                        DismissedDataGridView.Columns[7].Width = 50;
                        DismissedDataGridView.Columns[8].HeaderText = "Förfallodatum";
