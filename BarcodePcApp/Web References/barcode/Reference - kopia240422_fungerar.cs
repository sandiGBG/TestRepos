...
namespace BarcodePcApp.barcode
{
    ...
    public partial class BarcodeService : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("return", IsNullable = true)]
        public string GetReleaseProducts([System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string databas, [System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string kemiDb, double userid, double orgid, double verkid, double sprak)
        {
        ...
        /// <remarks/>
        public void GetReleaseProductsAsync(string databas, string kemiDb, double userid, double orgid, double verkid, double sprak)
        {
            this.GetReleaseProductsAsync(databas, kemiDb, userid, orgid, verkid,sprak);
        }

        /// <remarks/>
        public void GetReleaseProductsAsync(string databas, string kemiDb, double userid, double orgid, double verkid, double sprak, object userState)
        {
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("return", IsNullable = true)]
        public string GetInventoryList([System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string databas, [System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string kemdatabas, [System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string rumdatabas, double orgID, double lokalID, double cabinetID, double orgAr,double sprak)
        {
        ...
        /// <remarks/>
        public void GetInventoryListAsync(string databas, string kemdatabas, string rumdatabas, double orgID, double lokalID, double cabinetID, double orgAr, double sprak)
        {
            this.GetInventoryListAsync(databas, kemdatabas, rumdatabas, orgID, lokalID, cabinetID, orgAr,sprak);
        }

        /// <remarks/>
        public void GetInventoryListAsync(string databas, string kemdatabas, string rumdatabas, double orgID, double lokalID, double cabinetID, double orgAr, double sprak, object userState)
        {
        ...
        /// <remarks/>,
        /// 
        public void GetPrintingListAsync(string databas, string kemdatabas, string rumdatabas, double orgID, double lokalID, double cabinetID, double orgAr, string release, double sprak)
        {
            this.GetPrintingListAsync(databas, kemdatabas, rumdatabas, orgID, lokalID, cabinetID, orgAr, release,sprak);
        }

        /// <remarks/>
        public void GetPrintingListAsync(string databas, string kemdatabas, string rumdatabas, double orgID, double lokalID, double cabinetID, double orgAr, string release, double sprak, object userState)
        {
            ...
            this.InvokeAsync("GetPrintingList", new object[] {
                        ...
                        orgAr,
                        release,
                        sprak}, this.GetPrintingListOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("return", IsNullable = true)]
        public string FinnsProd([System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string databas, [System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string kemidatabas, [System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string cas, double prod, double verkid, double sprak)
        {
        ...
        /// <remarks/>
        public void FinnsProdAsync(string databas, string kemidatabas, string cas, double prod, double verkid, double sprak)
        {
            this.FinnsProdAsync(databas, kemidatabas, cas, prod, verkid,sprak);
        }

        /// <remarks/>
        public void FinnsProdAsync(string databas, string kemidatabas, string cas, double prod, double verkid, double sprak, object userState)
        {
