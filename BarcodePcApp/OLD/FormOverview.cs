    ...
    public partial class FormOverview : Form
    {
        ...
        private void FormOverview_Load(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(ds.Tables["ProdId"].Rows[0]["id"]) > 0)
            {
                ...
                this.buttonPrintPreview.Visible = true;
                this.buttonPrint2.Visible = true;
                this.buttonPrintPreview2.Visible = true;
                this.buttonPrint.Enabled = false;
                this.buttonPrintPreview.Enabled = false;
                this.buttonPrint2.Enabled = false;
                this.buttonPrintPreview2.Enabled = false;
                ...
                if (dt3.Rows.Count > 0) 
                {
                    ...
                    this.buttonPrintPreview2.Enabled = true;
...
/*            float fX = (float)Convert.ToDouble(ppea.Graphics.VisibleClipBounds.Width / FormMain.Get.BarcodeWidth);
            ...
            float nLeft = (float)Convert.ToDouble(((ppea.Graphics.VisibleClipBounds.Width - bc.Image.Width) / 2) / fX);
            if (nLeft < 0) nLeft = 0;
            ...
            if (FormMain.Get.BarcodeLayout == 0)
            {
                ...
                using (Font fnt1 = new Font("Arial", 8f, FontStyle.Regular))
                {
                    if (m_sCAS.Length > 0)
                    {
                        ppea.Graphics.DrawString(m_sCAS, fnt1, Brushes.Black, new RectangleF(nLeft * fX, (nTop - 3) * fY, ppea.Graphics.VisibleClipBounds.Width - nLeft * fX, fY * 3), drawFormat);
                    }
                    //ppea.Graphics.DrawString(m_sCaptionBelow, fnt1, Brushes.Black, new PointF(0F, bc.Image.Height+2)); 
                }
            }
            else if (FormMain.Get.BarcodeLayout == 1)
            {
                ...
                using (Font fnt1 = new Font("Arial", 6f, FontStyle.Bold))
                {
                    ...
                    {
                        drawFormat.Alignment = StringAlignment.Near;
                        ppea.Graphics.DrawString(m_sSummaformel, fnt1, Brushes.Black, new RectangleF(nLeft * fX, (nTop - 3) * fY, (ppea.Graphics.VisibleClipBounds.Width - nLeft * fX)/2, fY * 3), drawFormat);
                        drawFormat.Alignment = StringAlignment.Far;
                        ppea.Graphics.DrawString(m_sCAS, fnt1, Brushes.Black, new RectangleF(nLeft * fX + (ppea.Graphics.VisibleClipBounds.Width - nLeft * fX) / 2, (nTop - 3) * fY, (ppea.Graphics.VisibleClipBounds.Width - nLeft * fX) / 2, fY * 3), drawFormat);
                    }
                }
            }
            else if (FormMain.Get.BarcodeLayout == 2)
            {
                ...
                using (Font fnt1 = new Font("Arial", 6f, FontStyle.Bold))
                {
                    ...
                    {
                        drawFormat.Alignment = StringAlignment.Near;
                        ppea.Graphics.DrawString(m_sStreckkod, fnt1, Brushes.Black, new RectangleF(nLeft * fX, (nTop - 3) * fY + 1, (ppea.Graphics.VisibleClipBounds.Width - nLeft * fX) / 2, fY * 3 + 1), drawFormat);
                        drawFormat.Alignment = StringAlignment.Far;
                        ppea.Graphics.DrawString(m_sCAS, fnt1, Brushes.Black, new RectangleF(nLeft * fX + (ppea.Graphics.VisibleClipBounds.Width - nLeft * fX) / 2, (nTop - 3) * fY + 1, (ppea.Graphics.VisibleClipBounds.Width - nLeft * fX) / 2, fY * 3 + 1), drawFormat);
                        drawFormat.Alignment = StringAlignment.Center;
                        ppea.Graphics.DrawString(m_sSummaformel, fnt1, Brushes.Black, new RectangleF(nLeft * fX, (nTop) * fY + bc.Image.Height + 10, bc.Image.Width, bc.Image.Height), drawFormat);
                    }
                }
            }
